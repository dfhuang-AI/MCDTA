# -*- coding: utf-8 -*-
"""
Created on Wed May 24 15:29:00 2023
...
CONFIG_PATH_SMILES = './SMILES.yml'
smiles_encoding = get_config(CONFIG_PATH_SMILES)

x_map = {'symbol': ["H", "B", "C", "N", "O", "F", "Si", "P", "S", "Cl", "As", "Se", "Br", "Te", "I", "At", 
                    ['Be','Pt','Na','Ca','Fe','Ru','V','Re','Cu','Mg','Ir','Zn']],#, 'Te'],
         'atomic_weight': float,
         'n_valence': int,
         'num_hs': int,
         'degree': list(range(0, 10)),
         'hybridization': ['S', 'SP', 'SP2', 'SP2D', 'SP3', 'SP3D', 'SP3D2'],
...
class Featurizer:
    ...
    @staticmethod
    def tokens(smiles: List[str], max_smiles_length: int = 150, padding: bool = True, truncation: bool = True,
...
class GenFeatures(object):
    ...
    def __init__(self):
        self.symbols = ["H", "B", "C", "N", "O", "F", "Si", "P", "S", "Cl", "As", "Se", "Br", "Te", "I", "At",
                        ['Be','Pt','Na','Ca','Fe','Ru','V','Re','Cu','Mg','Ir','Zn']]#, 'Te'
    ...
    def __call__(self, data):
        ...
        for atom in mol.GetAtoms():
            ...
            if atom.GetSymbol() in ['Be','Pt','Na','Ca','Fe','Ru','V','Re','Cu','Mg','Ir','Zn']:
                symbol[-1] = 1.
            else:   
...
def compute_whim(smiles: List[str]):
    ...
    for smi in tqdm(smiles):
        ...
        if smi in whim_database:
            ...
            embed = AllChem.EmbedMolecule(mh, useRandomCoords=True, useBasicKnowledge=True, randomSeed=10,
                                          maxAttempts=5)
            ...
            if embed == -1:
                ...
                embed = AllChem.EmbedMolecule(mh, useRandomCoords=True, useBasicKnowledge=False, randomSeed=10,
